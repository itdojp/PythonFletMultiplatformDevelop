...
def main(page: ft.Page):
    ...
    project_name = ft.TextField(
        label="プロジェクト名", hint_text="例: My Flet App", width=500
    )
    ...
    def generate_checklist(_):
        ...
        for platform_name in selected_platforms:
            ...
            checklist_data["platforms"].append(
                {"name": platform_name, "checklist": platform_checklist}
            )
        ...
        json_path = (
            ...
            / "checklists"
            / f"{project_name.value or 'flet_app'}_checklist.json"
        )
    ...
    generate_button = ft.ElevatedButton(
        text="チェックリストを生成", on_click=generate_checklist, icon="checklist"
    )
    ...
    def export_checklist(_):
        if not checklist_preview.value:
            page.snack_bar = ft.SnackBar(
                content=ft.Text("チェックリストが生成されていません")
            )
        ...
        def save_result(e: ft.FilePickerResultEvent):
            if e.path:
                try:
                    ...
                    page.snack_bar = ft.SnackBar(
                        content=ft.Text(f"チェックリストを {e.path} に保存しました")
                    )
                    page.snack_bar.open = True
                except Exception as ex:
                    page.snack_bar = ft.SnackBar(
                        content=ft.Text(f"保存エラー: {str(ex)}")
                    )
                    page.snack_bar.open = True
            page.update()
    ...
    export_button = ft.ElevatedButton(
        text="Markdownとして保存", icon="download", on_click=export_checklist
    )

    # レイアウト
    page.add(
        ft.AppBar(
            title=ft.Text("Flet デプロイメントチェックリスト生成ツール"),
            center_title=True,
        ),
        ft.Container(
            content=ft.Column(
                [
                    ...
                    ft.Container(height=20),
                    ft.Text(
                        "生成されたチェックリスト", size=20, weight=ft.FontWeight.BOLD
                    ),
                    checklist_preview,
                    export_button,
                ]
...
def get_platform_checklist(platform_name):
    ...
    common_items = [
        {
            "id": "common_1",
            "text": "アプリの基本機能が正常に動作することを確認",
            "category": "機能テスト",
        },
        {"id": "common_2", "text": "レスポンシブデザインの検証", "category": "UI/UX"},
        {
            "id": "common_3",
            "text": "ダークモード/ライトモード両方での表示確認",
            "category": "UI/UX",
        },
    ...
    platform_items = {
        "Android": [
            ...
            {
                "id": "android_4",
                "text": "Google Play Store用のスクリーンショット準備",
                "category": "マーケティング",
            },
            {
                "id": "android_5",
            ...
            {
                "id": "android_7",
                "text": "Google Play Console開発者アカウントの確認",
                "category": "配布",
            },
            {
                "id": "android_8",
                "text": "アプリ内課金の設定（必要な場合）",
                "category": "収益化",
            },
            {
                "id": "android_9",
                "text": "Firebase Crashlyticsの設定（オプション）",
                "category": "モニタリング",
            },
        ...
        "iOS": [
            ...
            {
                "id": "ios_2",
                "text": "必要な権限の設定とUsage Descriptionの追加",
                "category": "設定",
            },
            {"id": "ios_3", "text": "異なるiOSデバイスでのテスト", "category": "UI/UX"},
            {
                "id": "ios_4",
                "text": "App Store用のスクリーンショット準備",
                "category": "マーケティング",
            },
            {"id": "ios_5", "text": "プライバシーポリシーの作成", "category": "法務"},
            {
                "id": "ios_6",
                "text": "アーカイブの生成とApp Store Connectへのアップロード",
                "category": "ビルド",
            },
            {
                "id": "ios_7",
                "text": "Apple Developer Programの有効期限確認",
                "category": "配布",
            },
            {
                "id": "ios_8",
                "text": "In-App Purchaseの設定（必要な場合）",
                "category": "収益化",
            },
            {
                "id": "ios_9",
                "text": "App Store Connect上のアプリ情報入力",
                "category": "配布",
            },
            {
                "id": "ios_10",
                "text": "TestFlightを使ったベータテスト",
                "category": "テスト",
            },
        ],
        "Web": [
            {
                "id": "web_1",
                "text": "ブラウザ互換性テスト（Chrome, Firefox, Safari, Edge）",
                "category": "互換性",
            },
            {
                "id": "web_2",
                "text": "レスポンシブWebデザインの検証",
                "category": "UI/UX",
            },
            {"id": "web_3", "text": "ファビコンの設定", "category": "アセット"},
            {
                "id": "web_4",
                "text": "SEO対策（メタタグ、OGタグ）",
                "category": "マーケティング",
            },
            {
                "id": "web_5",
            ...
            {
                "id": "web_6",
                "text": "サービスワーカーの設定（PWA対応）",
                "category": "機能",
            },
            {"id": "web_7", "text": "HTTPS対応の確認", "category": "セキュリティ"},
            {
                "id": "web_8",
                "text": "Webホスティングプラットフォームの選定",
                "category": "インフラ",
            },
        ...
        "Windows": [
            {
                "id": "windows_1",
                "text": "Windows 10/11での動作確認",
                "category": "互換性",
            },
            {
                "id": "windows_2",
                "text": "インストーラーパッケージの作成",
                "category": "配布",
            },
            {"id": "windows_3", "text": "MSIXパッケージの検討", "category": "配布"},
            {
                "id": "windows_4",
                "text": "Microsoft Storeへの登録検討",
                "category": "配布",
            },
            {
                "id": "windows_5",
                "text": "Windows通知システムとの連携",
                "category": "機能",
            },
            {
                "id": "windows_6",
        ...
        "Linux": [
            {
                "id": "linux_1",
                "text": "主要ディストリビューション（Ubuntu, Fedora等）での動作確認",
                "category": "互換性",
            },
