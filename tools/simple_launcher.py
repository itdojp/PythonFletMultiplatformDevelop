...
def main(page: ft.Page):
    ...
    # シンプルツールリスト
    tools = [
        {"name": "シンプルテスト", "file": "simple_test.py", "description": "Fletの基本機能テスト"},
        {"name": "テンプレートジェネレータ(シンプル)", "file": "simple_template_generator.py", "description": "シンプルなテンプレート生成ツール"}
    ]
    ...
    def launch_tool(e, file_name):
        ...
        try:
            ...
            page.snack_bar = ft.SnackBar(
                content=ft.Text(f"{file_name}を起動しました")
            )
