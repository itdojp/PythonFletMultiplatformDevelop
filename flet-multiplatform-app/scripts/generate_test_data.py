    ...
    def _generate_users(self, count: int) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            user = {
                ...
                'created_at': self._random_datetime('2022-01-01', '2023-12-31').isoformat(),
                'updated_at': self._random_datetime('2022-01-01', '2023-12-31').isoformat()
            }
            users.append(user)
    ...
    def _generate_orders(
        ...
        for i in range(count):
            ...
            status = random.choices(
                statuses,
                weights=[0.1, 0.2, 0.3, 0.35, 0.05],  # 確率の重み
                k=1
            )[0]
